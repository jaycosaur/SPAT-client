...
export default class Datasets extends Component {
  ...
  renderOverviewChart() {
        return (
          ['Your data has now been classifed and is ready for analysis.',
        <Button style={{marginTop:'16px'}} type='primary' href={'https://app.powerbi.com/view?r=eyJrIjoiZWQ0OGZlNzEtZTczZi00ZTY1LWIxZjItOGJiNzI3ZDk2MDZkIiwidCI6IjBmYmEyYjI1LTdkZmYtNDZiNi1hY2U1LTQ3OWFlYzNmMjY0NyJ9'}> View Analysis Dashboard </Button>]                                    
        )
  }
  ...
  render() {
    ...
    return (
      <div className="Datasets">
        {!this.state.dataset&& <div style={{height:'100vh',display:'flex',alignItems: 'center',justifyContent: 'center'           
          }}>
          <Spin
            indicator={<Icon type='loading' style={{fontSize: '100px', color: 'rgb(159,193,69)'}}/>}
            />
          </div>}
          {this.state.dataset && <DatasetContainer status={this.state.processState}>
                        ...
                        <Row type="flex" justify="center">
                          <Col md={20}>
                            <Row gutter={48} >
                              ...
                              <Col xs={24} md={10}> 
                                <Card title="Instance State" extra={<Icon type="calendar" />} hoverable>
                                  <Card style={{textAlign: 'center'}} hoverable>
                                    ...
                                    <p>
                                      {this.state.processState === "Processing Complete" ? this.renderOverviewChart() :["Please wait until processing is completed to view the summary"]}
                                    </p>
                                  </Card>
                                  ...
                                  <Timeline>
                                    ...
                                    <Timeline.Item>Dataset is currently pre-processing</Timeline.Item>
                                  </Timeline>
                              ...
                              <Col xs={24} md={14}> 
                                {(this.state.isTouched||this.state.isSaved)&&
                                  <Alert
