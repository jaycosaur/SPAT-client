...
import FlexTable from './../components/TableView'
...
const chartKey = "enterprise-dashboard-full-data"
    ...
    render() {
        return (
            ...
            <Card bodyStyle={{padding: 8 }} loading={!this.props.data.hasData&&!this.props.data.isError} hoverable>
                <EditableTableView  actions={this.props.actions} data={this.props.data.hasData&&this.props.selector(this.props.data.data)}/>
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ...
        fetchDataQuery: (filters) => {
            dispatch(fetchDataQuery(chartKey, "/data/ds-12345/query/datasetfullquery", filters))
        }
    }
}
